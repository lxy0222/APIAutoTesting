# -*- coding:utf-8 -*-
# @File    : test_ParentGoalWithPrivateKPI.py
# ****************************
...
class TestBusinessgoalcreate:
    param_value = case_dict["test_info"]  # 定义传递给 fixture 的参数

    @allure.title("{case_data[title]}")
    @pytest.mark.parametrize("case_data", case_dict["test_case"])
    @allure.story("ParentGoalWithPrivateKPI")
    def test_ParentGoalWithPrivateKPI(self, case_data):
        des = f"""
